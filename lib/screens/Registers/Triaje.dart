...
class GestionarTriaje extends StatefulWidget {
  const GestionarTriaje({super.key});
...
class _GestionarTriajeState extends State<GestionarTriaje> {
  ...
  final TextEditingController _nivelPrioridadController =
  ...
  final TextEditingController _saturacionOxigenoController =
      TextEditingController();
  final TextEditingController _presionArterialController =
      TextEditingController();
  final TextEditingController _descripcionController = TextEditingController();
  final TextEditingController _vision_inicial_odController =
      TextEditingController();
  final TextEditingController _vision_inicial_oiController =
      TextEditingController();
  @override
  void initState() {
    super.initState();
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(
                      height: 20), // Espacio adicional antes de los botones
                ],
              ),
            ),
          ),
          actions: [
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 8.0), // Espacio extra en la parte inferior
              child: Row(
                mainAxisAlignment:
                    MainAxisAlignment.end, // Alineamos los botones al final
                children: [
                  TextButton(
                    onPressed: () {
                    ...
                    onPressed: () {
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        TriajeServices()
                          ...
                          frecuenciaCardiaca:
                              double.parse(_frecuenciaCardiacaController.text),
                          frecuenciaRespiratoria: double.parse(
                              _frecuenciaRespiratoriaController.text),
                          temperatura:
                              double.parse(_temperaturaController.text),
                          saturacionOxigeno:
                              double.parse(_saturacionOxigenoController.text),
                          presionArterial: _presionArterialController.text,
                          descripcion: _descripcionController.text,
                          vision_inicial_od:
                              double.parse(_vision_inicial_odController.text),
                          vision_inicial_oi:
                              double.parse(_vision_inicial_oiController.text),
                        )
                            .then((success) {
                          if (success) {
                          ...
                          rows: triajes.map((triaje) {
                            return DataRow(
                              cells: <DataCell>[
                                        ...
                                        builder: (context) =>
                                          ...
                                          temperatura: double.tryParse(
                                                  triaje['temperatura']
                                                      .toString()) ??
                                              0.0,
                                          saturacionOxigeno: double.tryParse(
                                          ...
                                          visionInicialOd: double.tryParse(
                                                  triaje['vision_inicial_od']
                                                      .toString()) ??
                                              0.0,
                                          visionInicialOi: double.tryParse(
                                                  triaje['vision_inicial_oi']
                                                      .toString()) ??
                                              0.0,
                                        ),
                                      ),
                                ...
                                DataCell(
                                  Text(triaje['usuario_id'].toString()),
                                  onTap: () {
                                    // Aquí vamos a navegar a la pantalla de detalles
                                    Navigator.push(
                                      context,
